##working code for Inference on CNNLSTM+XGBoost classifier model using BB clipped images
...
loaded_model = xgb.Booster(model_file='/home/shefali/Master_Thesis_codes/Working_trained_models/Inference/XGBoost_model_with_CNNLSTM2.json')

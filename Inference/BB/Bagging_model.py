## working code of Inference of Bagging for CNN+LSTM model on BB clipped images
...
model1 = models.load_model('/home/shefali/Master_Thesis_codes/Trained_models/CNNLSTM_BB_10.h5',compile=False)
model2= models.load_model('/home/shefali/Master_Thesis_codes/Trained_models/CNNLSTM_BB_11.h5',compile=False)
model3 = models.load_model('/home/shefali/Master_Thesis_codes/Trained_models/CNNLSTM_BB_12.h5',compile=False)
model4 = models.load_model('/home/shefali/Master_Thesis_codes/Trained_models/CNNLSTM_BB_13.h5',compile=False)
model5 = models.load_model('/home/shefali/Master_Thesis_codes/Trained_models/CNNLSTM_BB_14.h5',compile=False)

bagged_models = [model1,model2,model3,model4,model5]
# Load YOLOv5 model
...
def reduce_size(image):
    image_reduced = cv2.resize(image, (96,96))
...
if __name__ == '__main__':
    ...
    while TRUE:
        ...
        start_time = time.time()  # Record the start time  
        predict = majority_voting_ensemble(bagged_models,img_data)

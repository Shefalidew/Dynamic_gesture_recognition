## working code of Inference for CNN+LSTM model on BB clipped images
...
model = models.load_model('/home/shefali/Master_Thesis_codes/Working_trained_models/Inference/CNNLSTM_BB_trained.h5',compile=False)
# Load YOLOv5 model

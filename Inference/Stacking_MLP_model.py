##Inference of Stacking (MLP) model

##working code for Inference on MediapipeLSTM+ MediapipeXGB + CNNLSTM
import cv2
import time
import warnings
import numpy as np
...
cnnlstm = models.load_model('/home/shefali/Master_Thesis_codes/Working_trained_models/final_CNN_RNN_model.h5',compile=False)
...
MLP_model = models.load_model('/home/shefali/Master_Thesis_codes/Working_trained_models/Meta_MLP_model.h5',compile=False)
                ...
                if results.pose_world_landmarks != None:
                    ...
                    for landmark in selected_pose_landmarks:
                        ...
                        if y_landmark > 96:
                            ...
                            y_landmark = 0    
                        z_landmark = depth_image[int(x_landmark), int(y_landmark)]*0.001
                        #*0.001   # Get depth in meters

## code for Inference on Mediapipe model
...
model = tf.keras.models.load_model('/home/shefali/Master_Thesis_codes/Trained_models/trained_model1.h5')
model.summary()
            ...
            while i < frames_capture:
               # Wait for a coherent pair of frames: depth and color
                ...
                if results.pose_landmarks != None:
                    selected_pose_landmarks = results.pose_landmarks.landmark[11:25] #landmarks scaled in range [0,1]
